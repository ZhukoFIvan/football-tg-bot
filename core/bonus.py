...
class BonusSystem:
    ...
    BONUS_MILESTONES = {
        ...
        10: 100,     # За 10-ю покупку - 100 ₽ на баланс
        15: 150,     # За 15-ю покупку - 150 ₽ на баланс
        20: 0,       # За 20-ю покупку - Усилитель D (выдается владельцем)
        25: 300,     # За 25-ю покупку - 300 ₽ на баланс
        30: 0,       # За 30-ю покупку - Скидка 5% (выдается владельцем)
        ...
        100: 0,      # За 100-ю покупку - 20 000 FC Points (выдается владельцем)
    }
